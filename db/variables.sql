...
wm_waterconsumption	watering.sosteco.watermetering	l	Consumo de agua	l	{0,100,150,300}	60	TRUE	{'SUM','AVG','MIN','MAX'}
wt_soilhumidity	watering.sosteco.sensor	h	Humedad del suelo	cb	{0,30,80,200}	30	TRUE	{'AVG','MIN','MAX'}
wt_pressure	watering.sosteco.sensor	p	Presión	atm	{0,0.6,0.8,1.2}	30	TRUE	{'AVG','MIN','MAX'}
wt_solaradiat	watering.sosteco.sensor	s	Radiación solar	pm	{0,0.4,0.8,1.1}	60	FALSE	{'AVG','MIN','MAX'}
wt_temperature	watering.sosteco.sensor	t	Temperatura	°C	{-30,30,35,60}	60	TRUE	{'AVG','MIN','MAX'}
mt_winddir	watering.sosteco.weatherstation	winddir	Dirección del viento	null	{null,null,null}	30	TRUE	{'MAX','MIN'}
mt_windvel	watering.sosteco.weatherstation	windvel	Velocidad del viento	km/h	{0,39,62,180}	30	TRUE	{'AVG','MIN','MAX'}
mt_pluvio	watering.sosteco.weatherstation	pluvio	Pluviometría	mm	{0,15,30,60}	60	TRUE	{'SUM','AVG','MIN','MAX'}
